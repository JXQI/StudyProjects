...
import argparse
from Train.segment_train import Process
import numpy as np
import random
...
if __name__=='__main__':
    ...
    parse.add_argument('--crop_size', type=tuple, default=(160,160), help='class task 2 or 3')
    ...
    pro = Process(device,batch_size=args.batch_size,num_worker=args.num_worker,lr=args.lr,num_class=args.num_class,
                  net=args.net,pretrained=args.pretrained,crop_size=args.crop_size)
